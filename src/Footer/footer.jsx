    ...
    return (
        <>
            ...
            <footer className="flex xl:flex-row lg:flex-row md:flex-col flex-col justify-between w-full items-center xl:px-16 lg:px-16 md:px-10 sm:px-10 px-10 pt-10 text-base bg-grey-500">
                ...
                <div className="xl:w-1/2 lg:w-1/2  text-left">
                    ...
                    <li style={{ listStyleType: "none" }}>
                        <div class="rounded flex h-full items-center">
                            ...
                            <span class="ml-2 title-font font-medium">Islamic English Course</span>
                        </div>
                    </li>
                    <li style={{ listStyleType: "none" }}>
                        <div class="rounded flex h-full items-center">
                    ...
                    <li style={{ listStyleType: "none" }}>
                        <div class="rounded flex h-full items-center">
                            ...
                            <span class="ml-2 title-font font-medium">www.islamicenglishcourse.com</span>
                        </div>
                    </li>
                </div>
            ...
            <div className="bg-green-400 mt-20">
