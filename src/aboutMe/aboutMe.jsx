  ...
  return (
    <div className="">
      <div>
        <p
          data-aos="fade-right"
          className="flex justify-center font-bold text-3xl text-black mt-14"
        >
          Popular Course
        </p>
      </div>
      ...
      <div className="flex justify-center pt-5">
        <p className="bg-green-700 rounded-lg font-semibold text-white px-5 py-3">Be Come Member !</p>
      </div>
      <div className="w-full h-7 mt-5 bg-green-700">
